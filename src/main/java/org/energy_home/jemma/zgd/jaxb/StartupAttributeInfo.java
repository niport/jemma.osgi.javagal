...
@XmlType(name = "StartupAttributeInfo", propOrder = { "startupAttributeSetIndex", "deviceType", "protocolVersion", "stackProfile", "channelMask", "extendedPANId", "panId",
		"shortAddress", "trustCenterAddress", "trustCenterMasterKey", "networkKey", "useInsecureJoin", "preconfiguredLinkKey", "networkKeySeqNum", "networkKeyType",
		"networkManagerAddress", "startupControl", "scanAttempts", "timeBetweenScans", "rejoinInterval", "maxRejoinInterval", "indirectPollRate", "parentRetryThreshold",
