...
public interface IGatewayEventManager {
	...
	/**
	 * Called to notify Reset Result's Event to all relevant registered listeners.
	 * 
	 * @param status
	 *          the status to notify to the listeners.
	 */
	...
	/**
	 * Called to notify Node Descriptor Extended's Event to the correct registered
	 * listener.
	 * 
	 * @param _requestIdentifier
	 *          identifies the target proxy to notify.
	 ...
	 *          the Address of Interest to notify.
	 */
	public void notifyNodeDescriptorExtended(int _requestIdentifier, Status _status, NodeDescriptor _node,
			Address _addressOfInterest);
	...
	/**
	 * Called to notify Leave Result's Event to all relevant registered listeners.
	 * 
	 * @param status
	 *          the status to notify to the listeners.
	 */
	...
	/**
	 * Called to notify Node Bindings Retrieved's Event to the correct registered
	 * listener.
	 * 
	 * @param _requestIdentifier
	 *          identifies the target proxy to notify.
	 ...
	 *          the status to notify to the listeners.
	 */
	public void notifyFrequencyAgility(Status status);
